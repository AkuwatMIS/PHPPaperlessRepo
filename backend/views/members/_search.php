...
//                'data' => array_merge(["" => ""], \common\components\Helpers\ListHelper::getLists('religions')),
                'data' => \common\components\Helpers\MemberHelper::getReligions(),
...
<!--            --><?php
            //$form->field($model, 'status')->dropDownList(\common\components\Helpers\ListHelper::getLists('member_status'), [ 'class'=>'form-control form-control-sm','prompt' => 'Select Status'])->label("Status")
            ?>
...
//                'data' => array_merge(["" => ""], \common\components\Helpers\ListHelper::getLists('gender')),
                'data' => \common\components\Helpers\MemberHelper::getGender(),
