...
<div class="container-fluid collapse border-0" id="demo">
    ...
    <div class="row">
        <div class="col-sm-3">
            <?= $form->field($model, 'parent_id')->label("Parent Id")->textInput(['placeholder'=>'Parent Id', 'class'=>'form-control form-control-sm']) ?>
        </div>

        <div class="col-sm-3">
            <?= $form->field($model, 'user_id')->label("User Id")->textInput(['placeholder'=>'User Id', 'class'=>'form-control form-control-sm']) ?>
        </div>
