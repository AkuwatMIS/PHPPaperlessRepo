        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    Html::a('<i class="glyphicon glyphicon-eye-open"></i>', ['applications-logs'],
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-envelope"></i> Applications listing',
