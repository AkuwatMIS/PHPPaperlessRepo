...
<div class="container-fluid collapse border-0" id="demo">
    ...
    <div class="row">
        <div class="col-sm-3">
            <?php
            echo $form->field($model, 'region_id')->dropDownList(ArrayHelper::map(StructureHelper::getRegions(),'id','name'), ['prompt' => 'Select Region'])->label('Region');
            ?>
        </div>
        <div class="col-sm-3">
            <?php
        ...
        <div class="col-sm-3">
            <?php
            echo $form->field($model, 'status')->label('Status')->textInput(['placeholder'=>'Status', 'class'=>'form-control form-control-sm']);
            ?>
        </div>
