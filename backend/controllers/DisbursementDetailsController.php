    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new DisbursementDetails",
                ...
                return [
                    ...
                    'title'=> "Create new DisbursementDetails",
                    'content'=>'<span class="text-success">Create DisbursementDetails success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update DisbursementDetails #".$id,
