...
class AwpTargetVsAchievementController extends Controller
{
    ...
    {   
        ...
        if($request->isAjax){
            ...
            return [
                    'title'=> "AwpTargetVsAchievement #".$id,
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new AwpTargetVsAchievement",
                ...
                return [
                    ...
                    'title'=> "Create new AwpTargetVsAchievement",
                    'content'=>'<span class="text-success">Create AwpTargetVsAchievement success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update AwpTargetVsAchievement #".$id,
    ...
    /**
     * Delete an existing AwpTargetVsAchievement model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing AwpTargetVsAchievement model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
