...
class DynamicReportsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $reports_list = ArrayHelper::map(ReportDefinations::find()->all(),'id','name');
    ...
    /**
     * Delete an existing DynamicReports model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing DynamicReports model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the DynamicReports model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DynamicReports the loaded model
