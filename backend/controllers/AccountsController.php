...
use common\models\search\Accounts as AccountsSearch;
...
class AccountsController extends Controller
{
    ...
    {    
        ...
        return $this->render('index', [
            ...
            'dataProvider' => $dataProvider,'array'=>([
                'branches'=>$branches,
            ]),
        ]);
    }
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Accounts",
                    'content'=>'<span class="text-success">Create Accounts success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Accounts model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Accounts model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
