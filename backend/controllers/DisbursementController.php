...
/**
 * DisbursementController implements the CRUD actions for Disbursements model.
 */
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Disbursements",
                ...
                return [
                    ...
                    'title'=> "Create new Disbursements",
                    'content'=>'<span class="text-success">Create Disbursements success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
