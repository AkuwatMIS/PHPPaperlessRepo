 ...
 * @property int $charges_due_amount
 ...
 * @property Loans $loan
 */
class SchedulesKpp extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['platform','application_id', 'loan_id', 'branch_id', 'assigned_to', 'created_by', 'updated_by','due_date','charges_schdl_amount','charges_due_amount'], 'integer'],
            [['schdl_amnt', 'overdue', 'overdue_log', 'advance', 'advance_log', 'due_amnt', 'credit','charges_schdl_amnt_tax','credit_tax'], 'number'],
