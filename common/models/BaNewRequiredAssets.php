...
/**
 * This is the model class for table "ba_new_required_assets".
 *
 * @property int $id
 * @property int $ba_id
 ...
 */
class BaNewRequiredAssets extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ba_id', 'application_id', 'assets', 'quantity', 'purchasing_price'], 'required'],
