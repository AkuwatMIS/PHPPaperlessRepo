...
/**
 * This is the model class for table "viga_loans".
 *
 * @property int $id
 ...
 */
class VigaLoans extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['loan_id', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'], 'integer'],
        ];
    }
