...
<? /*= $form->field($model, 'house_rent_amount')->textInput(['maxlength' => true]) */ ?>
...
<? /*= $form->field($model, 'total_household_income')->textInput(['maxlength' => true]) */ ?>
...
<? /*= $form->field($model, 'fatal_disease')->textInput() */ ?>

<? /*= $form->field($model, 'business_income')->textInput(['maxlength' => true]) */ ?>

<? /*= $form->field($model, 'job_income')->textInput(['maxlength' => true]) */ ?>

<? /*= $form->field($model, 'other_income')->textInput(['maxlength' => true]) */ ?>

<? /*= $form->field($model, 'expected_increase_in_income')->textInput(['maxlength' => true]) */ ?>
...
<? /*= $form->field($model, 'bm_verify_latitude')->textInput() */ ?>

<? /*= $form->field($model, 'bm_verify_longitude')->textInput() */ ?>
