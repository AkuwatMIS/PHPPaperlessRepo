...
$('body').on('beforeSubmit', 'form.formInstantDisb', function () {
     ...
     // submit form
     $.ajax({
          url: '/disbursements/save-takaf-loans?id='+loan_id,
          type: 'post',
          data: form.serialize(),
                ...
                foreach ($loans->getModels() as $key=>$loan) { ?>
                    <tr>
                        ...
                        <!-- <td><input class='form-control input-sm takaf -<?php /*echo $i*/?>-receive-date' type="text" id="receive_date"
                           ...
                           <td><input class="form-control input-sm takaf -<?php echo $i?>-credit" type="text" id="credit" name="Operations[credit]"  value=<?php echo (($loan->loan_amount*1)/100)?>></td>
