...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    Html::a('<i class="glyphicon glyphicon-download-alt"></i>', ['download-sample-rejected'],
                        ['title'=> 'Download Sample File','class'=>'btn btn-default','data-pjax' => '0','target'=>GridView::TARGET_BLANK]).
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create-rejected-disbursement'],
                    ['role'=>'modal-remote','title'=> 'Create new Rejected Transaction','class'=>'btn btn-default']).
