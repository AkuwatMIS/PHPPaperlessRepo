...
//    [
//        'header'=>\kartik\helpers\Html::checkbox('selection_all', false, ['class'=>'select-on-check-all', 'value'=>1, 'onclick'=>'$(".kv-row-checkbox").prop("checked", $(this).is(":checked"));']),
//        'contentOptions'=>['class'=>'kv-row-select'],
//        'content'=>function($model, $key){
//            return \kartik\helpers\Html::checkbox('selection[]', false, ['class'=>'kv-row-checkbox', 'value'=>$key, 'onclick'=>'$(this).closest("tr").toggleClass("danger");']);
//        },
//        'hAlign'=>'center',
//        'vAlign'=>'middle',
