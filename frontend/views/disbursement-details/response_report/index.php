...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <h6 class="address-heading"><span class="fa fa-list"></span> Transaction Logs </h6>
<?php echo $this->render('_searchDisbursementDetail', ['model' => $searchModel,'branches_names' => $branches_names,            'regions' => $regions
]);?>
            ...
            <span class="caret"></span></button>
             ...
             <ul class="dropdown-menu pull-right" role="menu" style="height: 30px;" aria-labelledby="menu1">
                <li role="presentation" >
                   <form action="/disbursement-details/disbursement-detail-response">
                     <input type="hidden" name="DisbursementDetailsSearch[sanction_no]" value="' . $searchModel->sanction_no . '">
                     <input type="hidden" name="DisbursementDetailsSearch[old_value]" value="' . $searchModel->old_value . '">
                     <input type="hidden" name="DisbursementDetailsSearch[new_value]" value="' . $searchModel->new_value . '">
                     <input type="hidden" name="DisbursementDetailsSearch[stamp]" value="' . $searchModel->stamp . '">
