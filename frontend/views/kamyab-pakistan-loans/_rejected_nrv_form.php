...
<div class="container-fluid border-0" id="demo">
    <?php $form = ActiveForm::begin([
        'action' => ['/kamyab-pakistan-loans/reject-nadra-verisys'],
        'method' => 'post',
    ]); ?>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <?php
            echo $form->field($model, 'reject_reason')
            ->dropDownList(
//                ['invalid_cnic'=>'Invalid Cnic',
//                'incorrect_name'=>'Incorrect Name',
//                'cnic_scanning_issue_mis'=>'CNIC Scanning Issue - MIS',
//                'profile_picture_issue_mis'=>'Profile Picture Issue - MIS',
//            'Issue Date not Show in MIS'=>'Issue Date not Show in MIS',
//            'wrong_gender_mis'=>'Wrong Gender - MIS',
//             'wrong_cnic_number_mis'=>'Wrong CNIC Number - MIS',
//             'Applicant/Parentage Name Data Entry Error - MIS'=>'Applicant/Parentage Name Data Entry Error - MIS',
//              'expired_cnic_nadra'=>'Expired CNIC - NADRA',
//              'Reprocessing Required in NADRA'=>'Reprocessing Required in NADRA',
//               'Duplicate CNIC - NADRA'=>'Duplicate CNIC - NADRA',
//               'Digitally impounded - NADRA'=>'Digitally impounded - NADRA',
//                'Deceased - NADRA'=>'Deceased - NADRA',
//                'System Independent - NADRA'=>'System Independent - NADRA',
//                'NADRA has never issued an identity card - NADRA'=>'NADRA has never issued an identity card - NADRA',
//                'Picture Mismatch on CNIC Card in NADRA'=>'Picture Mismatch on CNIC Card in NADRA'
                ['Blur NADRA e-Sahulat Token Attached – MIS'=>'Blur NADRA e-Sahulat Token Attached – MIS',
