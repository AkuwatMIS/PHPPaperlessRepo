...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <h6 class="address-heading"><span class="glyphicon glyphicon-list"></span>
            Dynamic Reports
            <?php if(in_array('frontend_create-accdynamicreportsAA',$permissions))
            { ?>
                <a href="/dynamic-reports/create-acc" class="btn btn-success pull-right" title="Create Reports" role="modal-remote">Create Reports</a>
