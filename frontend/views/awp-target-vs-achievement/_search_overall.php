   ...
   <div class="col-sm-2">
    ...
    <div class="col-sm-2">
        ...
        echo $form->field($model, 'area_id')->widget(\kartik\depdrop\DepDrop::classname(), [
            ...
            'pluginOptions'=>[
                'depends'=>['awptargetvsachievementsearch-region_id'],
                'initialize' => true,
                'initDepends'=>['awptargetvsachievementsearch-region_id'],
    ...
    <!--<div class="col-sm-2">
        <?php
/*        $value = !empty($model->project_id)?$model->project_id:null;
        echo $form->field($model, 'project_id')->widget(\kartik\depdrop\DepDrop::classname(), [
            'options' => ['class' => 'form-control input-sm'],
            'pluginOptions'=>[
                'depends'=>['awptargetvsachievementsearch-area_id'],
                //'initialize' => true,
                //'initDepends'=>['awptargetvsachievementsearch-area_id'],
                'placeholder'=>'All Projects',
                'url'=>\yii\helpers\Url::to(['/structure/fetch-projects-by-area'])
            ],
   ...
   <!-- <div class="col-sm-3">
    ...
    <div class="col-sm-2">
       <?= $form->field($model, 'month_from')->textInput(['placeholder'=>'Select Month From', 'class'=>'form-control input-sm'])->dropDownList(common\components\Helpers\AwpHelper::getMonthName()) ?>
       <?php
/*        echo $form->field($model, 'month')->widget(\yii\jui\DatePicker::className(), [
    ...
    <div class="col-sm-2">
    <?= $form->field($model, 'month')->textInput(['placeholder'=>'Select Month To', 'class'=>'form-control input-sm'])->dropDownList(common\components\Helpers\AwpHelper::getMonthName())->label('Month To') ?>
    </div>
    <div class="col-sm-2">
