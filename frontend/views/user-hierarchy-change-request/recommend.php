...
<div class="container-fluid">
    <header class="section-header">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h4>Transfer Recommendation By DA</h4>
                </div>
            </div>
        </div>
    </header>
    <div class="box-typical box-typical-padding">
        ...
        <?php $form = \yii\widgets\ActiveForm::begin([
            'action' => ['recommend-by-rm?id='.$model->id.''],
            'method' => 'post',
        ]); ?>
        <?php if ($model->status == 'pending'){ ?>
        <div class="form-group" style="margin-top: 20px">
            <?= \yii\helpers\Html::submitButton('Recommend', ['class' => 'btn btn-success pull-right']) ?>
            <?php }else{ ?>
            <div class="form-group" style="margin-top: 20px">
                <?= \yii\helpers\Html::submitButton('Recommended',  ['disabled'=>true,'class' => 'btn btn-success pull-right glyphicon glyphicon-ok']) ?>
                <?php } ?>
            <br>
