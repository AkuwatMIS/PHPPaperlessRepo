...
$this->title = 'Application Disbursement Report';
        ...
        var source =  
            {
                ...
                dataFields: [
                    ...
                    { name: \"disbursed_applications\", type: \"number\" },
                    { name: \"rejected_applications\", type: \"number\" },
        ...
        $(\"#treeGrid\").jqxTreeGrid(
            {
                ...
                filterMode: 'simple',
                columns: [
                    { text: \"Regions\",pinned: true, align: \"center\", dataField: \"name\", width: 250 },
                    { text: \"No of Applications\", cellsAlign: \"center\", cellsFormat: 'n', dataField: \"objects_count\" , align: \"center\", width: 270 },
                    { text: \"No of Disbursed Applications\", dataField: \"disbursed_applications\", cellsAlign: \"center\", cellsFormat: 'n', align: \"center\",width: 270 },
                    { text: \"Rejected Applications\", dataField: \"rejected_applications\", cellsAlign: \"center\", cellsFormat: 'n', align: \"center\",width: 270 }
...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <?php $form = ActiveForm::begin([
            'action' => ['application-details-report'],
            'method' => 'post',
        ]); ?>
