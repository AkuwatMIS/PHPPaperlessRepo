...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <a class="pull-right btn btn-primary" href="/recoveries/recovery-summary">Daily Recovery Summary Report</a>
        <h6 class="address-heading"><span class="fa fa-bank"></span> Recovery Summary Report(Monthly)</h6>
            ...
            <div class="dropdown pull-right" style="margin-bottom:5px">
                ...
                <ul class="dropdown-menu pull-right" role="menu" style="height: 30px;" aria-labelledby="menu1">
                    <li role="presentation">
                        <form action="/account-reports/recovery-summary">
