...
<div style="border:1px solid #d6e9c6;padding:10px;">
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            ...
            //die();
            ?>
            <?= Html::dropDownList('n', $n, $number_array, array('class' => 'form-control', 'id' => 'n', 'prompt' => '# Recoveries')) ?>
            <div class="help-block"></div>
        </div>
...
<div class="customer-form" style="margin-top: 10px;">
    ...
    <section class="card card-green mb-3">
        <header class="card-header">
            <i class="fa fa-bank"></i> Post Recoveries
            ...
            <div class="panel panel-success">
                <div class="panel-body container-items"><!-- widgetContainer -->
                    <div class="row">
                        ...
                        <div class="col-lg-3 text-center"><h6>Borrower (CNIC)</h6></div>
                        ...
                        <div class="col-lg-1 text-center"><h6>MDP</h6></div>
                    ...
                    <?php foreach ($model as $index => $modelRecovery):
                        ...
                        <div class="item panel panel-default"><!-- widgetBody -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-1">
                                    <?= $form->field($modelRecovery, "[{$index}]amount")->textInput(['maxlength' => true, 'placeholder' => 'amount'])->label(false) ?>
                                </div>
                                <div class="col-lg-1">
                                    <?= $form->field($modelRecovery, "[{$index}]mdp")->textInput(['maxlength' => true, 'value' => 0, 'placeholder' => 'MDP'])->label(false) ?>
                                </div>
                                <div class="col-lg-1">
                            ...
                            if (!empty($modelRecovery->id)) {
                                ?>
                                <div
                                        style="opacity:1;background-color: #26B99A;position: absolute;">Recovery
                                    Save
                                    Succesfully
                                </div>
                                <?php
                            ...
                            <div class="alert alert-success" style="display:none;"><?php echo $modelRecovery->id;
                                !empty($modelRecovery->id) ? 'Recovery Save Successfully' : ''; ?></div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p>Are you sure to add recovery in previous month?</p>
