...
<div class="container-fluid collapse border-0" id="demo">
    <?php $form = ActiveForm::begin([
        'action' => ['rejected-pending-applications'],
        'method' => 'get',
    ]); ?>
    <div class="row">
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
            <?= $form->field($model, 'status')->dropDownList(['rejected'=>'Rejected','pending'=>'Pending'], [ 'class'=>'form-control form-control-sm','prompt' => 'Select Status'])->label("Status") ?>
        </div>
        <div class="col-sm-3">
