...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        ...
        <?php echo $this->render('_searchconstructionapprovallist', ['model' => $searchModel, 'regions' => $regions]); ?>
        <?= GridView::widget([
            'id' => 'crud-datatable',
                    ...
                    'buttons' => [
                        'visit_history' => function ($url, $model, $key) {
                            if (in_array($model->project_id, \common\components\Helpers\StructureHelper::trancheProjects())) {
                                return \yii\helpers\Html::a('<span class="glyphicon glyphicon-picture"></span>', ['construction-visit-details', 'appId' => $model->id, 'visitId'=>$model->visit_id], ['target' => '_blank'], ['title' => 'Visit History']);
                            }
                        }
                    ],
