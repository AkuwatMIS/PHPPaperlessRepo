...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <h6 class="address-heading"><span class="fa fa-list"></span>S.E Visits Approval</h6>
        <?php echo $this->render('_searchvisitsapprovallist', ['model' => $searchModel, 'regions' => $regions]); ?>
        <?= GridView::widget([
            'id' => 'crud-datatable',
                    ...
                    'buttons' => [
                        'visit_history' => function ($url, $model, $key) {
                            if (in_array($model->project_id, \common\components\Helpers\StructureHelper::trancheProjects())) {
                                return \yii\helpers\Html::a('<span class="glyphicon glyphicon-picture"></span>', ['shifted-visit-details', 'appId' => $model->id, 'visitId'=>$model->visit_id], ['target' => '_blank'], ['title' => 'Visit History']);
                            }
                        }
                    ],
                    'template' => '{visit_history} {approve}',
