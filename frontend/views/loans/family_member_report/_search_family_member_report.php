...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-2">
            <?= $form->field($model, 'member_name')->label("Member Name")->textInput(['placeholder' => 'Mmeber Name', 'class' => 'form-control input-sm']) ?>
        </div>
        <div class="col-sm-2">
            <?= $form->field($model, 'member_parentage')->label("Member Parentage")->textInput(['placeholder' => 'Mmeber Parentage', 'class' => 'form-control input-sm']) ?>
        </div>
        <div class="col-sm-2">
            <?= $form->field($model, 'member_cnic')->label("Member CNIC")->textInput(['placeholder' => 'Mmeber CNIC', 'class' => 'form-control input-sm']) ?>
        </div>
        <div class="col-sm-2">
            <?= $form->field($model, 'family_member_cnic')->label("Family Member CNIC")->textInput(['placeholder' => 'Family Member CNIC', 'class' => 'form-control input-sm']) ?>
        </div>
        <div class="col-sm-2">
            <?php
