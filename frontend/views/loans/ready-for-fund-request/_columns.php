...
return [
    ...
    [
        ...
        'attribute'=>'bank_name',
        'label'=>'Bank Name',
        'value'=>'loan.application.member.membersAccounts.bank_name'
    ],
    [
        //'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'account_title',
        'label'=>'Account Title',
        'value'=>'loan.application.member.membersAccounts.title'
    ],
    [
        //'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'account_no',
        'label'=>'Account No',
        'value'=>'loan.application.member.membersAccounts.account_no'
    ]
];   