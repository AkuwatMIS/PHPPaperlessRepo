...
<div class="container-fluid collapse border-0" id="demo">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <?php
            echo $form->field($model, 'status')->dropDownList(['pending'=>'Pending','collected'=>'Collected','not collected'=>'Not Collected','rejected'=>'Rejected'], ['required'=>'Required','prompt' => 'Select Loan Status'])->label('Loan Status');
            ?>
        </div>
    </div>
