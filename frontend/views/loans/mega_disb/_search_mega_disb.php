...
<div class="container-fluid">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['mega-disbursement-report'],
        'method' => 'get',
    ]); ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-2">
            <?php
            echo $form->field($model, 'date_approved')->widget(DateRangePicker::classname(), [
                'convertFormat'=>true,
                'options' => ['class' => 'form-control input-sm', 'placeholder' => 'Approved Date'],
                'pluginOptions'=>[
