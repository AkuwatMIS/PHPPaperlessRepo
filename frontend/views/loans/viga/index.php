...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        ...
        <div>
            <?= \yii\helpers\Html::button('Add to Viga', [
        ...
        <?=\yii\helpers\Html::beginForm(['loans/viga'],'post');?>
        ...
        <label class='control-label'>Are You Sure to add these loans to Viga?</label>
