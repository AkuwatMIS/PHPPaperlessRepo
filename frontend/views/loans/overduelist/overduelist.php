...
<div class="container-fluid">
    <div class="box-typical box-typical-padding">
        <h6 class="address-heading"><span class="fa fa-list"></span> Overdue Report</h6>
        <?php
        echo $this->render('_search_overduelist', [
            ...
            <div class="loans-index">
                <div id="ajaxCrudDatatable">
                    ...
                    echo \yii\grid\GridView::widget([
                        'columns' => require(__DIR__ . '/_columns_overduelist.php'),
                     ...
                     <div class="dropdown pull-right">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu" style="height: 30px;" aria-labelledby="menu1">
                            <li role="presentation" >
                                <form action="/loans/overdue-list">
