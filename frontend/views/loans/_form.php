...
<div class="loans-form">
    ...
    <div class="row">
        ...
        <?php } else if (in_array($application->project_id, [89, 92, 96, 100, 101, 129])) { ?>
            <div class="col-sm-3">
                <?php if ($application->project_id == 96 || $application->project_id == 100 || $application->project_id == 101 || $application->project_id == 129) { ?>
