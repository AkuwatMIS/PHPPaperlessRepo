...
<div class="container-fluid">
    ...
    <div class="branch-requests-form">
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <?= $form->field($model, 'status')->dropDownList(['0' => 'Recommend', '2' => 'Rejected'], ['prompt' => 'Select...']) ?>
            <?= $form->field($model, 'recommend_remarks')->textarea(['maxlength' => true])->label('Recommend Remarks') ?>
