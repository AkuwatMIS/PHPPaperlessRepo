...
$js = "
    ...
    $(document).ready(function(){
        $('.field-usertransfers-approved_remarks').show();
        ...
        $('#usertransfers-status').change(function(){
            ...
            if(selected_value == '0'){
                   ...
                   $('.field-usertransfers-approved_remarks').hide();
            }
        });
    });
...
<div class="container-fluid">
    ...
    <div class="branch-requests-form">
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <?= $form->field($model, 'status')->dropDownList(['0' => 'Approved', '2' => 'Rejected'], ['prompt' => 'Select...']) ?>
            <?= $form->field($model, 'approved_remarks')->textarea(['maxlength' => true])->label('Approved Remarks') ?>
