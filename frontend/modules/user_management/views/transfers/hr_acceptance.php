...
$js = "
    ...
    $(document).ready(function(){
        $('.field-usertransfers-hr_acceptance_remarks').show();
        ...
        $('#usertransfers-status').change(function(){
            ...
            if(selected_value == '0'){
                   ...
                   $('.field-usertransfers-hr_acceptance_remarks').hide();
            }
        });
    });
...
<div class="container-fluid">
    ...
    <div class="branch-requests-form">
        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <?= $form->field($model, 'status')->dropDownList(['0' => 'HR Acceptance', '2' => 'Rejected'], ['prompt' => 'Select...']) ?>
            <?= $form->field($model, 'hr_acceptance_remarks')->textarea(['maxlength' => true])->label('HR Acceptance Remarks') ?>
            <?= $form->field($model, 'reject_reason')->textarea(['maxlength' => true]) ?>

            <div class="form-group">
                <?= Html::submitButton('Approved', ['class' => 'btn btn-primary']) ?>
            </div>
