...
use common\models\search\VigaLoansSearch as VigaLoansSearch;
 ...
 */
class VigaLoansController extends Controller
{
    ...
    {    
        $searchModel = new VigaLoansSearch();
     ...
     * @param integer $id
     * @return VigaLoans the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = VigaLoans::findOne($id)) !== null) {
            return $model;
        } else {
